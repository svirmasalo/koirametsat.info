...
<template>
  <header class="pt-16 pb-0 px-4 text-center relative">
    <div class="absolute top-4 right-4 md:top-8 md:right-8">
      <nuxt-link class="text-indigo-50 bg-indigo-600 linear-gradient to-right from-indigo-700 to-indigo-600 hover:bg-indigo-800 transition-colors text-sm md:text-base p-1 md:p-2 rounded font-bold flex items-center gap-2" to="/tietoa-palvelusta/tue-koirametsat-infon-toimintaa">
