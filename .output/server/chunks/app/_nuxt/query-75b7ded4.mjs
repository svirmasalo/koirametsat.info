...
import { u as useRuntimeConfig, e as useNuxtApp, b as useRequestEvent } from '../server.mjs';
import { ref } from 'vue';
import { parse, serialize } from 'cookie-es';
import { appendHeader } from 'h3';
import destr from 'destr';
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-f9828228.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-9747c539.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-75b7ded4.mjs.map
