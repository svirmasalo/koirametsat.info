import { f as useState, u as useRuntimeConfig, _ as __nuxt_component_0$1 } from '../server.mjs';
...
import { q as queryContent, e as encodeQueryParams, j as jsonStringify, u as useCookie } from './query-75b7ded4.mjs';
import { b as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-f9828228.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import '@unhead/vue';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-9747c539.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-25688351.mjs.map
